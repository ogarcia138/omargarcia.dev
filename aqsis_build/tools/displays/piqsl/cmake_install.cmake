...
if(CMAKE_INSTALL_COMPONENT STREQUAL "main" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/aqsis" TYPE MODULE FILES "/home/ogarcia138/aqsis_build/tools/displays/piqsl/piqsl_dspy.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/aqsis/piqsl_dspy.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/aqsis/piqsl_dspy.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/aqsis/piqsl_dspy.so"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "main" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/home/ogarcia138/aqsis_build/tools/displays/piqsl/CMakeFiles/piqsl_dspy.dir/install-cxx-module-bmi-Release.cmake" OPTIONAL)
endif()
